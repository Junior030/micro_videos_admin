...
describe('CategoriesController Integration Tests', () => {
  ...
  beforeEach(async () => {
    const mudule: TestingModule = await Test.createTestingModule({
      imports: [ConfigModule.forRoot(), DatabaseModule, CategoriesModule],
    }).compile();
    controller = mudule.get<CategoriesController>(CategoriesController);
    repository = mudule.get<ICategoryRepository>(
